...
# def open_file(request, hash: str, quality: str) -> tuple:
#     _video = get_object_or_404(Video, hash=hash)
#     _video.increment_views(request)

#     path = Path(_video.sources.first().file.path)
